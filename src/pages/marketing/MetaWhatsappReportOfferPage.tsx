                            ...
                            <div className="meta-paper-shine relative overflow-hidden rounded-[34px] border border-[#d7dfec] bg-white p-3 shadow-[0_42px_120px_rgba(28,43,69,0.18)] sm:p-5">
                                ...
                                >
                                    {videoEmbedUrl ? (
                                        ...
                                        <div className="relative flex aspect-video items-center justify-center px-6 text-center">
                                            ...
                                            <div className="relative z-10 flex max-w-xl flex-col items-center gap-4">
                                                <div className="flex h-20 w-20 items-center justify-center rounded-full border border-white/16 bg-white/10 shadow-[0_0_40px_rgba(255,255,255,0.12)] backdrop-blur">
